 ...
 */
const WalletBalance = () => {
  const { totalUsdValue, loading } = useAppSelector((state) => state.wallet);
  ...
  return <div className={styles.walletBalance}>
    ...
    <div className={styles.walletBalanceBalanceRow}>
      ...
      <span className={styles.walletBalanceBalanceValue}>{loading ? <Loading /> : totalUsdValue.toLocaleString()}</span>
